...
extension SideMenuView{
    ...
    private var driverRetingSectionView: some View{
        HStack{
            infoSectionViewCell(title: "Hoạt động", value: "83")
            infoSectionViewCell(title: "Xếp hạng", value: "4.989")
        }
        .padding(.vertical)
    }
...
extension SideMenuView{
    private var listOptionsView: some View{
        VStack(alignment: .leading, spacing: 5){
            ...
            PrimaryButtonView(title: "Đăng xuất", bgColor: .blue, fontColor: .white) {
