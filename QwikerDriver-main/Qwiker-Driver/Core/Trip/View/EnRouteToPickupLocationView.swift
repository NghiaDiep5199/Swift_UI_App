...
extension EnRouteToPickupLocationView{
    ...
    private var arrivedSlider: some View{
        TripStatusSliderView(title: "Đã đến") {
    ...
    private var actionButtons: some View {
          HStack {
              ...
              CircleButtonWithTitle(title: "Gọi", imageName: "phone.fill", action: {
                  isCalling = true // Đánh dấu đang thực hiện cuộc gọi
                  ...
                  if isCalling {
                      ...
                      isCalling = false // Đặt lại trạng thái gọi sau khi kết thúc cuộc gọi
                  }
              })
              Spacer()
              CircleButtonWithTitle(title: "Huỷ chuyến", imageName: "xmark", action: {
