...
extension LoginView{
    ...
    private var userNameTf: some View{
        PrimaryTextFieldView(label: "Email" , text: $authVM.email)
    ...
    private var alredyAccountSection: some View{
        HStack {
            ...
            Button {
                ...
                Text(authVM.viewState == .login ? "Đăng kí" : "Đăng nhập")
    ...
    private var submitButton: some View{
        PrimaryButtonView(showLoader: authVM.isShowLoader, title: authVM.viewState == .login ? "Gửi mã code" : "Đăng kí") {
